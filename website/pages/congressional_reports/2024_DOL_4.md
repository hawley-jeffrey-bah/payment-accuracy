...
- ActionsTaken:
  ...
  - Agency: DOL
    ...
    Type: TEXT
  - Agency: DOL
    Answer: "ETA continues to hold managers and states accountable for reduction of\
    ...
    Type: TEXT
  - Agency: DOL
    Answer: While the Department has determined a fraud risk tolerance level for the
    ...
    Type: TEXT
  - Agency: DOL
    Answer: The FY 2025 President’s Budget request proposes a comprehensive package
...
- ActionsTaken:
  ...
  - Agency: DOL
    ...
    Type: TEXT
  - Agency: DOL
    Answer: The program has staff responsible for establishing and maintaining sufficient
    ...
    Type: TEXT
  - Agency: DOL
    Answer: The agency has sufficient resources to reduce improper and unknown payments.  There
