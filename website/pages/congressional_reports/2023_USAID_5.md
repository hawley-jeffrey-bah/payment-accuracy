...
- Indent: 1
  ...
  Type: REGULAR
SurveyData:
- Answer: USAID implements improved controls, enhanced training and better data management
    practices to prevent future overpayments from occurring.
...
- Answer: '0.25'
  ...
  Subheading: ''
  Type: MILLIONS_OF_DOLLARS
- Answer: '3.0566083873334'
  Heading: Overpayment Amount Determined to Not Be Collectible
  Key: arp4_1
  SortOrder: 15
  Subheading: ''
  Type: PERCENTAGE
- Answer: USAID has arisen in the review of health insurance premium payments for
    employees.  The bills were issued to collect the outstanding amounts.
  Heading: Overpayment Amount Determined to Not Be Collectible
  Key: ara2_2
  SortOrder: 16
  Subheading: ''
