...
- ActionsTaken:
  ...
  - Agency: DOT
    ...
    Type: TEXT
  - Agency: DOT
    Answer: FHWA's Office of the Chief Financial Officer (HCF) monitors Enterprise
    ...
    Type: TEXT
  - Agency: DOT
    Answer: 'DOT focuses its accountability mechanisms on the closure of corrective
...
- ActionsTaken:
  ...
  - Agency: DOT
    ...
    Type: TEXT
  - Agency: DOT
    Answer: "DOT’s Deputy Chief Financial Officer (DCFO) is the senior accountable\
