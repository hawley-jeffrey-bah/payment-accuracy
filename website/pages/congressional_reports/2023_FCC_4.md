...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: The actions taken were aimed at making the Distribution signers responsible
    ...
    Type: TEXT
  - Agency: FCC
    Answer: The error found was a result of manual intervention which is rare in the
    ...
    Type: TEXT
  - Agency: FCC
    Answer: No resources were requested in the most recent budget submission of the
...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: 'The High Cost Program will continue to focus on program integrity assurance
    ...
    Type: TEXT
  - Agency: FCC
    Answer: 'The High Cost program has the internal controls, human capital, information
    ...
    Type: TEXT
  - Agency: FCC
    Answer: 'The program did not identify additional resources needed to improve the
...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: "USAC and its manual review vendor have robust Quality Assurance processes\
    ...
    Type: TEXT
  - Agency: FCC
    Answer: The Lifeline program has the internal controls, human capital, information
      systems and other infrastructure it requires to reduce improper payments to
...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: "The top two causes for this year’s Improper Payments are related to competitive\
    ...
    Type: TEXT
  - Agency: FCC
    Answer: The Schools and Libraries program has the internal controls, human capital,
    ...
    Type: TEXT
  - Agency: FCC
    Answer: The Schools and Libraries program team did not identify additional resources
