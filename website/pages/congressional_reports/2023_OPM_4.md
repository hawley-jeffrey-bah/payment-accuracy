...
- ActionsTaken:
  ...
  - Agency: OPM
    ...
    Type: TEXT
  - Agency: OPM
    Answer: 'An upgrade to the current legacy system is needed to properly categorize
    ...
    Type: TEXT
  - Agency: OPM
    Answer: Using the existing internal controls, human capital, and information systems
    ...
    Type: TEXT
  - Agency: OPM
    Answer: An upgrade to the current legacy system is needed to categorize the root
