...
- ActionsTaken:
  ...
  - Agency: HUD
    ...
    Type: TEXT
  - Agency: HUD
    Answer: 'Training will provide knowledge to the Owners/Agents on their role in
      the testing process. If Owners/Agents understand and are able to timely provide
    ...
    Type: TEXT
  - Agency: HUD
    Answer: "In HUD's Audit Management Systems (AMS), for Single Audit Act (SAA) audits\
    ...
    Type: TEXT
  - Agency: HUD
    Answer: 'As a result of extraordinary level of effort by HUD and contract administrators,
