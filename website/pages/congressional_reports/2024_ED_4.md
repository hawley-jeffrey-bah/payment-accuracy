...
- ActionsTaken:
  ...
  - Agency: ED
    ...
    Type: PERCENTAGE
  - Agency: ED
    Answer: These were accounting errors that resulted in rounding errors made by
    ...
    Type: TEXT
  - Agency: ED
    Answer: 'Department personnel, including executive managers and staff, are held
...
- ActionsTaken:
  ...
  - Agency: ED
    ...
    Type: TEXT
  - Agency: ED
    Answer: "Key management officials have annual performance appraisal elements that\
  ...
  - Agency: ED
    ...
    Type: TEXT
  - Agency: ED
    Answer: The most recent budget provides $2.7 billion for Student Aid Administration,
