...
- Answer: OGE's payments are so small in most cases that conducting audit activity
    ...
    number and amounts of payments, no improper payments have yet to be identified
    and negate the need to conduct recovery audits.
