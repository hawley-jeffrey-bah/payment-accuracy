...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: TEXT
  - Agency: FCC
    Answer: 'USAC’s payment recapture audits are the known as Beneficiary and Contributor
  ...
  - Agency: FCC
    ...
    Type: TEXT
  - Agency: FCC
    Answer: The High Cost program team did not identify additional resources needed
...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: USAC and its manual review vendor have robust Quality Assurance (QA) processes
    ...
    Type: TEXT
  - Agency: FCC
    Answer: 'The FCC works through it''s program administrator, USAC to complete payment
...
- ActionsTaken:
  ...
  - Agency: FCC
    ...
    Type: PERCENTAGE
  - Agency: FCC
    Answer: "The Schools and Libraries team is using data analytics to identify potential\
    ...
    Type: TEXT
  - Agency: FCC
    Answer: 'USAC’s payment recapture audits are known as Beneficiary and Contributor
